...
**Name:** John A. Sexton - [LinkedIn](https://www.linkedin.com/in/john-sexton-8b943a18/) <br>
**Title:** Staff Software Engineer <br>
**Focus areas:** Platform SRE | DevOps Architecture | Cloud Architecture | CICD | DevOps Thought Leader | Public Speaker

### **SUMMARY**
Staff Software Engineer specializing in Platform Site Reliability Engineer (SRE), DevOps Engineer, responsible for DevOps automation, configuration management, Infrastructure as Code (IaC), audit, compliance, test automation, and security compliance in a large enterprise, mission critical, core revenue, environment with geographically dispersed systems, and teams utilizing Kanban, Agile, Scrum & Lean methodologies, leveraging best in class industry standard practices as defined by CNCF & quantified by industry whitepapers like the annual DORA State of DevOps Report
...
**GCP Tooling:** Kubernetes, GKE, GCE, GCE, GCS, PubSub, Spanner, Datastore, Dataflow, GCLB, CloudArmor, gcloudSDK <br>
**CONTAINER ORCHESTRATION:** Kubernetes, AppEngine, CloudRun, Anthos, Docker, Rocket, Helm, Tiller <br>
**CICD:** Spinnaker, Helm, Jenkins-X, Jenkins, Cloudbees Enterprise Jenkins, Hudson <br>
**CONFIGURATION MGMT:** Docker, Chef, Ansible
**SCM:** Git, GitLab Enterprise, GitHub, Subversion (SVN)
**LANGUAGES:** Groovy, Bash, Python, Ruby, SQL, REST, Java <br>
**TOOLING:** Nginx, Prometheus, Grafana, Stackdriver,
OS: Linux (Alpine, CoreOS, Ubuntu, RHEL, Debian), HPUX, Solaris
PaaS: RedHat Openshift, Pivotal Cloud Foundry
